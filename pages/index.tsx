...
import BottomCard from "client/features/home/BottomCard";
import HamburgerNav from "client/features/home/HamburgerNav";
import LongCard from "client/features/home/LongCard";
import NavContainer from "client/features/home/NavContainer";
import SmallCard from "client/features/home/SmallCard";
      ...
      <div className="w-full tablet:w-11/12 desktop:w-2/3">
        <div className="flex flex-wrap desktop:w-full pt-20 tablet:pt-0">
          ...
          <BottomCard
            ...
            description2={"Interested in collaborating with us? "}
            link={{ content: "Together Github", href: "https://github.com/Caleb-Cohen/Together" }}
            img={"/threeHumans.png"}
          />
        </div>
      </div>
