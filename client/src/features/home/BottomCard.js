...
const BottomCard = ({ heading, title, description, img }) => (
  <section className="border-solid border-2 border-black rounded-xl bg-secondary flex justify-center py-6 flex-col lg:flex-row xl:gap-10 w-full">
    <div className="flex flex-col items-center gap-8 text-center w-full lg:max-w-xl">
      ...
      <div className="flex flex-col items-center gap-1">
        ...
        <div className="flex border-2 border-slate-400 bg-white rounded-xl">
