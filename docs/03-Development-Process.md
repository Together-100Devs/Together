...
- To keep the commit history clean, we require that you squash your commits into a single commit using interactive rebase:
  ...
  - This shows all commits since you branched off of main: `git rebase -i upstream/main`
...
| **2. Push to your fork**<br>_First push:_<br>`git push -u origin feature/branch-name`<br>_Updates:_<br>`git push` | **2. Push to your fork**<br>_First push:_<br>`git push -u origin feature/branch-name`<br>_Updates after rebase:_<br>`git push --force-with-lease` |
| **3. Open a PR** against `upstream/main`                                                                          | **3. Open a PR** against `upstream/main`                                                                                                          |
| Merge commits are preserved in history.                                                                           | Commit history is rewritten to be linear (no merge commits).                                                                                      |
