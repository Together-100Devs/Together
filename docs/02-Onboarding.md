...
- Click on New Application in the top-right corner.
  ...
  <p><img src="images/button.JPG" alt="Screenshot of the button" width="100"></p>

- After naming your app navigate to 0Auth2 in the menu on the left.
- Click "Add Redirect" and set to `http://localhost:2121/api/auth/discord/callback`.

  <p><img src="images/redirect-button.jpg" alt="Screenshot of the button" width="500"></p>

- Locate Client ID right above. Click "Reset Secret" button and enter your discord password to get secret. Maks sure to copy both.

  <p><img src="images/client-secret.JPG" alt="Screenshot of the button" width="500"></p>
...
**Then open localhost:3000 and try to log in through Discord!**
